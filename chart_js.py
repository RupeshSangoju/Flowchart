...
def generate_chart(request: ChartRequest):
    return {"chart_syntax": generate_chartjs_syntax(request.user_input, request.chart_type)}

if __name__ == "__main__":
    user_input = input("Enter your data or text: ")
    chart_type = input("Enter chart type (Line, Bar, Pie, Radar, Scatter, Bubble, Mixed): ")
    print("\nGenerated Chart.js Syntax:\n")
    print(generate_chartjs_syntax(user_input, chart_type))
